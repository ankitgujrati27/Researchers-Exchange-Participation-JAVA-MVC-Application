    ...
    <body>
        ...
        <div id="main_section">
            ...
            <div class="form_container">
                <div class="transparent_box form_head"> Contact Us </div>
                <div class="transparent_box loginform_pad">
                
                    <form method="post" action="confirmc.jsp">
                        <table>
                            ...
                            <tr>
                                ...
                                <td> <input type="email" name="email_id" size="35" required> </td>
                            </tr>
                            
                            <tr>
                                <td> Message<span>* </span> </td>
                                <td> <textarea cols="27"></textarea> </td>
                            </tr>
